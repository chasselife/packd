...
export class ChecklistComponent implements OnInit, OnDestroy {
  ...
  openNewChecklistDialog(): void {
    this.router.navigate(['/chckd/checklist/new']);
  }

  openNewChecklistGroupDialog(): void {
    this.router.navigate(['/chckd/checklist-group/new']);
  }
  ...
  openEditChecklistDialog(checklist: Checklist): void {
    if (checklist.id) {
      this.router.navigate(['/chckd/checklist', checklist.id, 'edit']);
    }
  }
  ...
  openImportPage(): void {
    this.router.navigate(['/chckd/import']);
  }

  openExportPage(): void {
    this.router.navigate(['/chckd/export']);
  }

  openSearchPage(): void {
    this.router.navigate(['/chckd/search']);
  }
  ...
  onGroupEditClick(group: ChecklistGroup, event: Event): void {
    event.stopPropagation();
    if (group.id) {
      this.router.navigate(['/chckd/checklist-group', group.id, 'edit']);
    }
  }
